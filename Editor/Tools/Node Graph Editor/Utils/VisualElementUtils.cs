...
namespace Konfus.Tools.NodeGraphEditor.Utils
{
    public static class VisualElementUtils
    {
        ...
        public static T SetOffset<T>(this T ve, float top, float bottom, float left, float right)
        ...
        public static T SetMargin<T>(this T ve, float top, float bottom, float left, float right)
            where T : VisualElement
        {
