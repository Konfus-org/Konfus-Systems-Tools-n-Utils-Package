...
namespace Konfus.Tools.NodeGraphEditor
{
    public class BaseEdgeDragHelper : EdgeDragHelper
    {
        ...
        protected Dictionary<NodeView, List<PortView>> compatiblePorts = new();
        ...
        public override bool HandleMouseDown(MouseDownEvent evt)
        {
            ...
            foreach (KeyValuePair<NodeView, List<PortView>> kp in compatiblePorts)
        ...
        private Rect GetPortBounds(NodeView nodeView, int index, List<PortView> portList)
        {
