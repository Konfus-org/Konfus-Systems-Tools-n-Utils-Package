...
namespace Konfus.Tools.NodeGraphEditor
{
    ...
    public class PortDataDrawer : PropertyDrawer
    {
        ...
        private StyleBackground IdentifierTextBackground =>
            (StyleBackground) EditorGUIUtility.IconContent("d_Text Icon").image;

        private StyleBackground IdentifierSOBackground =>
            (StyleBackground) EditorGUIUtility.IconContent("d_ScriptableObject Icon").image;
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty portDataProperty)
        {
            SerializedProperty displayNameProperty =
                portDataProperty.FindPropertyRelative(PortData.DisplayNameFieldName);
            SerializedProperty displayTypeProperty =
                portDataProperty.FindPropertyRelative(PortData.DisplayTypeFieldName);
            SerializedProperty showAsDrawerProperty =
                portDataProperty.FindPropertyRelative(PortData.ShowAsDrawerFieldName);
            ...
            VisualElement identifierContainer = DrawIdentifierGUI(portDataProperty);
            ...
            VisualElement multiEdgeContainer = DrawMultiEdgeGUI(portDataProperty);
        ...
        {
            SerializedProperty acceptMultipleEdgesProperty =
                portDataProperty.FindPropertyRelative(PortData.AcceptMultipleEdgesFieldName);
            SerializedProperty edgeProcessOrderProperty =
                portDataProperty.FindPropertyRelative(PortData.EdgeProcessOrderFieldName);
            ...
            acceptMultipleEdgesField.RegisterCallback<GeometryChangedEvent>(e =>
                FixBrokenIndentation(acceptMultipleEdgesField, e));
        ...
        private VisualElement DrawIdentifierGUI(SerializedProperty portDataProperty)
        {
            ...
            SerializedProperty identifierObjectProperty =
                portDataProperty.FindPropertyRelative(PortData.IdentifierObjectFieldName);
            SerializedProperty useIdentifierObjectProperty =
                portDataProperty.FindPropertyRelative(PortData.UseIdentifierObjectFieldName);
            ...
            identifierObjectField.RegisterCallback<GeometryChangedEvent>(e =>
                FixBrokenIndentation(identifierObjectField, e));

            Button useIdentifierObjectButton = new Button().SetSize(14, 14).SetMargin(0, 0, 8, 2);
