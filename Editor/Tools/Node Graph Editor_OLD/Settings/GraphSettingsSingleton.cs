...
namespace Konfus.Tools.Graph_Editor.Editor.Settings
{
    ...
    public class GraphSettingsSingleton : ScriptableSingleton<GraphSettingsSingleton>
    {
        ...
        /// </summary>
        [NonSerialized] public GraphSettingsAsset settingsAsset = null;

        /// <summary>
        /// The actual GraphSettings that are serialized. 
        /// </summary>
        public GraphSettings settings = new();
        ...
        public static GraphSettingsAsset BlueprintSettings
        {
            get
            {
                if (blueprintSettings == null)
                {
                    ...
                    {
                        Debug.LogError(
                            $"settings blueprint could not be resolved! Path: {blueprintSettingsPath} GUID: {GraphSettings.assetGUID}");
        ...
        {
            SerializedProperty blueprintProperty =
                new SerializedObject(BlueprintSettings).FindProperty(dest.propertyPath);
