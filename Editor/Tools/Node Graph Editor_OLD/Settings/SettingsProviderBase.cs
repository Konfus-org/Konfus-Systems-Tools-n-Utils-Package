...
namespace Konfus.Tools.Graph_Editor.Editor.Settings
{
    ...
    public abstract class SettingsProviderBase : SettingsProvider
    {
        ...
        {
            if (serializedObject != null) return serializedObject.targetObject.name;
            return "";
        }
        ...
        public override void OnActivate(string searchContext, VisualElement rootElement)
        {
            ...
            var settingsRoot = new VisualElement();
            ...
            UIElementsHelper.CreateGenericUI(serializedObject, settingsRoot, GetValueChangedCallback(),
                GetCreateAdditionalUIAction(), GetRootPropertyPath());
