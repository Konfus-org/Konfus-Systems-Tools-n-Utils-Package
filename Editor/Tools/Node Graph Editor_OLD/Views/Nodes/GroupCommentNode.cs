...
namespace Konfus.Tools.Graph_Editor.Views.Nodes
{
    ...
    public class GroupCommentNode : INode, IUtilityNode
    {
        ...
        /// </summary>
        [SerializeField] [HideInInspector] private float width = 300;
        ...
        /// </summary>
        [SerializeField] [HideInInspector] private float height = 300;

        [SerializeField] private Color groupColor = new(30f / 255f, 30f / 255f, 30f / 255f, 0.5f);
        ...
        private List<NodeView> containedNodes = new();
        ...
        private static VectorImage DragCaretGraphics
        {
            get
            {
                if (dragCaretGraphics == null)
                {
                    ...
                    dragCaretGraphics = ScriptableObject.CreateInstance<VectorImage>();
                    painter.fillColor = Color.white;
                    painter.BeginPath();
                    painter.MoveTo(new Vector2(0, imageSize));
                    painter.LineTo(new Vector2(imageSize, 0));
                    painter.LineTo(new Vector2(imageSize, imageSize));
                    painter.LineTo(new Vector2(0, imageSize));
                    painter.Fill();
        ...
        public void Initialize(NodeController nodeController)
        {
            ...
            var colorfield = nodeView.inspectorContent.Q<PropertyField>(nameof(groupColor));
        ...
        private void OnNodeViewMouseDown(MouseDownEvent evt)
        {
            ...
            if (evt.button == 0)
            {
                ...
                if (containedNodes == null) containedNodes = new List<NodeView>();
        ...
        private void OnPositionChange(PositionData obj)
        {
            ...
            foreach (NodeView nodeView in containedNodes)
            {
                ...
                nodeView.SetPosition(new Vector2(nodePos.x + nodeMoveDelta.x, nodePos.y + nodeMoveDelta.y));
            }
        ...
        private void OnMouseMove(MouseMoveEvent evt)
        {
            ...
            Undo.RecordObject(nodeController.graphController.graphData,
                nameof(GroupCommentNode) + " Dimension change.");
