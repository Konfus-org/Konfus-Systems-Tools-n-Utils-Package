...
using Konfus.Tools.Graph_Editor.Editor.Attributes;
...
namespace Konfus.Tools.Graph_Editor.Views
{
    ...
    public class ContextMenu : GraphSearchWindowProvider
    {
        ...
        /// </summary>
        protected static Dictionary<Type, string> nodeTypeToCreationLabel = new();
        ...
        {
            return GraphSettingsSingleton.Settings.searchWindowRootHeader;
        }
        ...
        protected void AddNodeEntriesDefault()
        {
            ...
            foreach (Type nodeType in nodeTypes)
                ...
                if (nodeType.ImplementsOrInherits(typeof(INode)))
                {
                    ...
                    NodeAttribute nodeAttribute = Node.GetNodeAttribute(nodeType);
                    ...
                    else if (!categoryPath.EndsWith(endSlash)) categoryPath += endSlash;
                    if (!categoryPath.StartsWith(endSlash)) categoryPath = endSlash + categoryPath;
                    ...
                    createNodeLabel =
                        (!isUtilityNode
                            ? GraphSettingsSingleton.Settings.createNodeLabel
                            : GraphSettingsSingleton.Settings.createUtilityNodeLabel) + createNodeLabel;
        ...
        {
            AddSeparator(GraphSettingsSingleton.Settings.searchWindowCommandHeader);
            AddShortcutEntry(Actions.Frame, SearchTreeEntry.AlwaysEnabled, graphController.FrameGraph);
            AddShortcutEntry(Actions.Rename, () => graphController.graphView.GetSelectedNodeCount() == 1,
                graphController.OnRename);
            ...
            AddShortcutEntry(Actions.Delete,
                () => graphController.graphView.HasSelectedEdges() || DefaultEnabledCheck(),
