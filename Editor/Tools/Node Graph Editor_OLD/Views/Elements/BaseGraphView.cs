...
{
    public abstract class BaseGraphView : VisualElement
    {
        ...
        protected BaseGraphView()
        {
            ...
            //
            // Content Container
            ContentContainer = new GraphElementContainer(this);
            ...
            //
            // Layers
            m_ContainerLayers = new Dictionary<int, Layer>();

            // Create Marquee 
            m_Marquee = new Marquee();
        ...
        public virtual BaseEdge CreateEdge()
        {
            return new Edge();
        }
        ...
        {
            return new(orientation, direction, capacity);
        }
        ...
        public GraphElementContainer GetContentContainer()
        {
        ...
        private VisualElement GetLayer(int index)
        {
            ...
            {
                layer = new Layer {name = $"Layer {index}"};
        ...
        public void OnDragOffer(DragOfferEvent e, bool forceViewDrag = false)
        {
            ...
            else if (IsMarqueeDrag(e))
            {
                ...
                m_Marquee.Coordinates = new Marquee.RectangleCoordinates
                {
                    start = position,
                    end = position
                };
        ...
        private void OnDragEnd(DragEndEvent e)
        {
            if (m_DraggingMarquee)
            {
                ...
                foreach (GraphElement element in ContentContainer.ElementsAll)
                {
                    ...
                    if (element.Selected) somethingSelected = true;
                }

                if (somethingSelected) OnActionExecuted(Actions.SelectionChanged);
                m_DraggingMarquee = false;
            }
            else if (m_DraggingView)
            {
        ...
        protected void ExecuteShortcutHandler(KeyCode keyCode, EventModifiers modifiers)
        {
            ...
            if (internalActions.ContainsKey(keyAction)) internalActions[keyAction]();
            ...
            out Vector3 frameScaling)
        {
            ...
            Matrix4x4 transformMatrix =
                Matrix4x4.TRS(Vector3.zero, Quaternion.identity, new Vector3(zoomLevel, zoomLevel, 1.0f));
