...
namespace Konfus.Tools.Graph_Editor.Views.Elements
{
    ...
    public class EditableLabelElement
    {
        ...
        public EditableLabelElement(PropertyField propertyField, System.Action<string> onValueChange = null,
            System.Action onEditModeLeft = null)
        {
        ...
        public void EnableInput(bool enable = true)
        {
            if (isInitialized)
            {
                ...
                if (!enable) onEditModeLeft?.Invoke();
            }
        }
    }
}