...
namespace Konfus.Tools.Graph_Editor.Views
{
    ...
    public class SearchWindow : EditorWindow
    {
        ...
        private List<SearchTreeGroupEntry> m_SelectionStack = new();
        ...
        private void Init(ScriptableObject provider, VisualElement visualElement)
        {
            m_Owner = provider;
        ...
        private void CreateSearchTree()
        {
            ...
            else
            {
                ...
                var match = m_Tree[0] as SearchTreeGroupEntry;
                int level = 0;
                while (true)
                {
        ...
        */
        ...
        private void RebuildSearch()
        {
            ...
            var matchesStart = new List<SearchTreeEntry>();
            var matchesWithin = new List<SearchTreeEntry>();
        ...
        private void SelectEntry(SearchTreeEntry e, bool shouldInvokeCallback)
        {
            ...
            else if (shouldInvokeCallback)
            {
                ...
                if (e.actionToExecute != null) Close();
            }
        }
        ...
        {
            var children = new List<SearchTreeEntry>();
            int level = -1;
            int i = 0;
