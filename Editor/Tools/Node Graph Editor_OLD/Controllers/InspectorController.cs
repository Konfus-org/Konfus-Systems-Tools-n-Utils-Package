...
namespace Konfus.Tools.Graph_Editor.Editor.Controllers
{
    ...
    public class InspectorController<T> where T : Graph
    {
        ...
        public InspectorController(VisualElement parent)
        {
            ...
            */
            ...
            var startLabel = new Label(GraphSettingsSingleton.Settings.noGraphLoadedLabel);
        ...
        {
            if (visible != isInspectorVisible) EditorPrefs.SetBool(GraphSettings.isInspectorVisiblePrefsKey, visible);
            ...
            else
            {
                ...
                inspectorRoot.style.minWidth =
                    inspectorRoot.style.maxWidth = GraphSettingsSingleton.Settings.inspectorWidth;
        ...
        public void SetSelectedNodeInfoActive(int nodeCount = 0, int edgeCount = 0, bool active = true)
        {
            ...
            {
                return SelectText(ref selectedCount, GraphSettingsSingleton.Settings.node);
            }

            string DoEdgeText(ref int selectedCount)
            {
                return SelectText(ref selectedCount, GraphSettingsSingleton.Settings.edge);
            }
            ...
            else
            {
                if (nodeCount > 0 && edgeCount > 0)
                    multipleNodesSelected.text =
                        $"{DoNodeText(ref nodeCount)} and {DoEdgeText(ref edgeCount)} {GraphSettingsSingleton.Settings.multipleSelectedMessagePartial}";
                else
                    multipleNodesSelected.text =
                        $"{(nodeCount > 0 ? DoNodeText(ref nodeCount) : DoEdgeText(ref edgeCount))} {GraphSettingsSingleton.Settings.multipleSelectedMessagePartial}";
            }
        ...
        public void SetInspectorContent(VisualElement content, SerializedObject serializedObject = null)
        {
            ...
            if (content != null)
            {
                ...
                if (serializedObject != null) selectedNodeInspector.Bind(serializedObject);
            }
        }
        ...
        private void CreateButtonClicked()
        {
            ...
            if (File.Exists(uniqueFilename)) uniqueFilename = AssetDatabase.GenerateUniqueAssetPath(uniqueFilename);
            ...
            if (path.Length != 0)
            {
                var graphData = ScriptableObject.CreateInstance<T>();
        ...
        public void CreateRenameGraphUI(T graph)
        {
            ...
            if (graph.serializedGraphData == null) graph.CreateSerializedObject();
            ...
            var editableLabel = new EditableLabelElement(labelField, onEditModeLeft: () =>
            {
                ...
                if (graphAssetPath != null && originalName != name)
                {
                    ...
                    Debug.Log($"The provided name ({name}) was empty or not a valid filename!");
        ...
        */
        ...
        public void Draw()
        {
                ...
                EditorGUIUtility.GetObjectPickerControlID() == currentPickerWindow)
            {
                ...
                if (pickedObj != null)
                {
                    var graph = EditorGUIUtility.GetObjectPickerObject() as T;
