...
namespace Konfus.Tools.Graph_Editor.Editor.Helpers
{
    public static class UIElementsHelper
    {
            ...
            EventCallback<SerializedPropertyChangeEvent> changeCallback = null)
        {
            ...
            if (changeCallback != null) propertyField.RegisterCallback(changeCallback);
        ...
        public static void CreateGenericUI(SerializedObject serializedObject, VisualElement root,
            EventCallback<SerializedPropertyChangeEvent> changeCallback = null,
            Action<SerializedProperty, VisualElement> CreateAdditionalUI = null, string rootPropertyPath = null)
        {
            SerializedProperty rootProperty = null;
            if (rootPropertyPath != null) rootProperty = serializedObject.FindProperty(rootPropertyPath);
            ...
            void ForEachProperty(ref ScrollView scrollView)
            {
                ...
                if (prop.NextVisible(true))
                    do
                    {
                        if (prop.name != "m_Script") creationLogic(prop.Copy(), scrollView);
