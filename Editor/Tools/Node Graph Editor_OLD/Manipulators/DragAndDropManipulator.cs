...
namespace Konfus.Tools.Graph_Editor.Editor.Manipulators
{
    public class DragAndDropManipulator : Manipulator
    {
        ...
        {
            m_PickList = new List<VisualElement>();
        ...
        internal void SetDraggedElement(VisualElement element)
        {
            m_Dragged = element;
        }

        internal VisualElement GetDraggedElement()
        {
            return m_Dragged;
        }
    ...
    public abstract class DragAndDropEvent<T> : MouseEventBase<T> where T : DragAndDropEvent<T>, new()
    {
        ...
        internal float GetDragThreshold()
        {
            return m_DragThreshold;
        }

        internal void SetMouseDelta(Vector2 delta)
        {
            mouseDelta = delta;
        }
        ...
        {
            return ParentManipulator.GetDraggedElement();
        }
        ...
        {
            return ParentManipulator.GetUserData();
        }
    ...
    public abstract class DragEventBase<T> : DragAndDropEvent<T> where T : DragEventBase<T>, new()
    {
        ...
        {
            ParentManipulator.SetUserData(data);
        }
    }
