    ...
    public class SelectableManipulator : MouseManipulator
    {
        ...
        protected override void RegisterCallbacksOnTarget()
        {
            ...
            if (m_Selectable == null)
                throw new Exception("SelectableManipulator can only be added to ISelectable elements");
        ...
        protected void OnMouseDown(MouseDownEvent e)
        {
            ...
            if (m_Selectable.Selected && !wasSelected) fireAction(Actions.SelectionChanged, m_Selectable);
        }
    }
}