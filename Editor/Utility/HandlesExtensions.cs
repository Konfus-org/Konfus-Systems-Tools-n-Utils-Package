...
namespace Konfus.Editor.Utility
{
    public static class HandlesExtensions
    {
        public static void DrawWireCapsule(Vector3 center, float radius, float height)
        {
            ...
            Handles.DrawLine(center + new Vector3(0, pointOffset, -radius),
                center + new Vector3(0, -pointOffset, -radius));
            Handles.DrawLine(center + new Vector3(0, pointOffset, radius),
                center + new Vector3(0, -pointOffset, radius));
            ...
            Handles.DrawLine(center + new Vector3(-radius, pointOffset, 0),
                center + new Vector3(-radius, -pointOffset, 0));
            Handles.DrawLine(center + new Vector3(radius, pointOffset, 0),
                center + new Vector3(radius, -pointOffset, 0));
