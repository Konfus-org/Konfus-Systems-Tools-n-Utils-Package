...
namespace Konfus.Editor.Utility
{
    public static class SerializedPropertyUtility
    {
        ...
        private static readonly Regex ElementIdentifier = new(@"^[_a-zA-Z][_a-zA-Z0-9]*(\[[0-9]*\])+$");

        private static readonly Regex ElementIndex = new(@"^(\[[0-9]*\])+$");

        private static readonly Regex MemberIdentifier = new(@"^[_a-zA-Z][_a-zA-Z0-9]*$");
