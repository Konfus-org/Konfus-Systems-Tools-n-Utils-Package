...
{
    /// <summary>
    ///     Implement this interface on a BaseNode, it allows you to automatically spawn a node if an asset of type T is
    ///     dropped in the graphview area
    /// </summary>
    ...
    {
        /// <summary>
        ///     This function is called just after creating the node from an object and allows you to initialize the node with the
        ///     object data.
        /// </summary>
