...
#pragma warning restore CS0618
            if (oldType == null || !exposedParameterTypeCache.TryGetValue(oldType, out Type newParamType))
                return null;
    ...
    public class FloatParameter : ExposedParameter
    {
        ...
        {
            get => val;
            set => val = value != null ? (float) value : 0;
        }
        ...
        public class FloatSettings : Settings
        {
            ...
            public override bool Equals(Settings param)
            {
                return base.Equals(param) && mode == ((FloatSettings) param).mode &&
                       min == ((FloatSettings) param).min && max == ((FloatSettings) param).max;
            }
        }
    }
