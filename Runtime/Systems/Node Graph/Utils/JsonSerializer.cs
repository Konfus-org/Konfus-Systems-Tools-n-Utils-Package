...
namespace Konfus.Systems.Node_Graph
{
    ...
    public static class JsonSerializer
    {
        ...
        public static JsonElement SerializeNode(Node node)
        {
            return Serialize(node);
        }

        public static Node DeserializeNode(JsonElement e)
        {
            try
            {
                ...
                var node = Activator.CreateInstance(baseNodeType) as Node;
#if UNITY_EDITOR
