...
namespace Konfus.Systems.Node_Graph
{
    ...
    public class MultiEdgeInputAttribute : InputAttribute
    {
        ...
        public MultiEdgeInputAttribute(string name = null,
            string processOrder = EdgeProcessOrder.DefaultEdgeProcessOrder, Type displayType = null)
        {
            this.name = name;
    ...
    public class CustomPortBehaviorAttribute : Attribute
    {
        ...
        /// <param name="cloneResults">
        ///     Whether to create a memberwise clone. Used to avoid reference to PortData conflicts when
        ///     checking changes.
        /// </param>
    ...
    {
        public EdgeProcessOrderKey Key { get; }
    ...
    public class CustomMenuItem : Attribute
    {
        ...
        /// <summary>
        ///     Register the node creation method in the NodeProvider class. The node creation method will also be available in the
    ...
    public class CustomMenuItemFilter : Attribute
    {
        ...
        /// <summary>
        ///     Used alongside CustomMenuItemAttribute to filter a certain Port to a Type. Can only be used to remove NodeTypes
        ///     from the Menu.
    ...
    public class CustomClassMenuItem : CustomMenuItem
    {
        ...
        /// <param name"key">Key to check for with other attributes like CustomMenuItemFilter</param>
        /// <param name="args">
        ///     Extra args will get sent to the specified method allowing the same method to produce different
        ///     results
        /// </param>
        public CustomClassMenuItem(string menuTitle, Type methodParentClass, string methodName, object key = null,
            params object[] args)
        {
            this.menuTitle = menuTitle;
