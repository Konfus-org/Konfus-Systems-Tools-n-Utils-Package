...
namespace Konfus.Systems.Graph.Attributes
{
    ...
    public class NodeAttribute : Attribute
    {
        ...
        public NodeAttribute(string color = null, string categories = "", string inputPortName = null,
            Capacity inputPortCapacity = Capacity.Multiple, string nodeName = null, bool createInputPort = true)
        {
            if (color != null) ColorUtility.TryParseHtmlString(color, out this.color);
