...
namespace Konfus.Multiplayer
{
    public static class MatchmakingService
    {
        ...
        {
            var playerName = await AuthenticationService.Instance.GetPlayerNameAsync().ContinueOnSameContext();
            var playerNameProperty = new PlayerProperty(playerName, VisibilityPropertyOptions.Member);
            return new Dictionary<string, PlayerProperty>() { { PLAYER_NAME_KEY, playerNameProperty } };
        }

        public static async Task CreateSessionAsync(string name, int maxPlayers)
        {
            var playerProperties = await GetPlayerProperties().ContinueOnSameContext();
            ...
            ActiveSession = await MultiplayerService.Instance.CreateSessionAsync(sessionOptions).ContinueOnSameContext();
        ...
        {
            var availableSessions = await QuerySessionsAsync().ContinueOnSameContext();
